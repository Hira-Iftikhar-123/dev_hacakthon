  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <TextBox>
        ...
        <p> Unlock your potential with a smart solution that identifies skill gaps, guides your learning journey, verifies your strengths, and connects you to the right job opportunities—bridging the gap between talent and career success.
      </p>
      </TextBox>
    </FullHeightSection>
    ...
    <SectionContent>
      ...
      >
        <Grid
          ...
          md={6}
          sx={{
            animation: `${id === "dashboard" ? fadeInRight : id === "courses"? fadeInLeft: fadeInRight} 1s ease-in-out`,
            textAlign: "center", 
          }}
        >
         <ImageWrapper sx={{ display: "flex", justifyContent: "flex-start", alignItems: "center" }}>
  <img
    src={id === "dashboard" ? "/dash.png" : id === "courses" ? "course.jpg" : "job.jpg"}
    alt={`Section ${index + 2}`}
    style={{ 
      width: "auto",  // Prevent the image from stretching to full width
      maxWidth: "600px",  // Set the maximum width to limit the image size
      height: "auto",  
      marginLeft: 0,  // Align the image to the left
      marginRight: "auto"  // Ensure the image stays left-aligned
    }} 
  />
</ImageWrapper>
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            {id === "dashboard" ? "Your dashboard" : id === "courses" ? "Recommended Courses": "Job Recommendation"}
          </Typography>
          <Typography
            sx={{
